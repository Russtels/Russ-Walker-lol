...
namespace refactor
{
    class InputSimulator
    {
        ...
        public static void SendMiddleMouseUp()
        {
            INPUT[] inputs = new INPUT[1];
            INPUT input = new INPUT
            {
        ...
        public static void PressItemKey(int slot)
        {
            switch (slot)
            {
                case 1: PressKey(ScanCodeShort.KEY_1); break;
                case 2: PressKey(ScanCodeShort.KEY_2); break;
                case 3: PressKey(ScanCodeShort.KEY_3); break;
                // El slot 4 es para wards, lo saltamos.
                case 5: PressKey(ScanCodeShort.KEY_5); break;
                case 6: PressKey(ScanCodeShort.KEY_6); break;
                case 7: PressKey(ScanCodeShort.KEY_7); break;
                default: break; // No hacer nada si el slot no es válido
            }
        }
